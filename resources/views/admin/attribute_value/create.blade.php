        ...
        <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form action="{{route('attribute_value.store')}}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        <h6 for="category_id">Thuộc loại sản phẩm:</h6>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên của thuộc tính" class="form-control" name="value" required autofocus>
                        </div>
