      ...
      <table class="table table-striped table-bordered" id="example" width="100%" cellspacing="0">
        ...
        @foreach($products as $product)
            <tr>
                ...
                <td style="width: 5%;" class="text-center"><img width="150px" src="{{asset('../public/admin_asset/img/product/'.$product->image)}}" alt=""></td>
                ...
                <form action="{{ route('products.destroy', $product->id) }}" class="form-delete" role="form" method="post" style="display: inline">
                    @csrf
                    @method('delete')
