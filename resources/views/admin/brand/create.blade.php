        ...
        <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading">
                    <span class="splash-description">Create Brand</span>
                </div>
                <div class="panel-body">
                    ...
                    <form action="{{route('brands.store')}}" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên của brand" class="form-control" name="name" required autofocus>
                        </div>
                        <div class="form-group">
                            <label for="content">Content:</label>
                            <textarea rows="4" cols="50" name="content" class="form-control" placeholder="Nhập thông tin của brand"></textarea>
                        </div>    
                        <div class="form-group">
